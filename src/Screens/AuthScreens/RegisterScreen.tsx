                ...
                <View style={[loginScreenStyles.loginContainer]}>
                    ...
                    <View style={[inputStyles.inputContainer]}>
                        <TextInput
                            ...
                            right={<TextInput.Icon icon={pvisible?"eye":"eye-off"} color={colors.primary} onPress={()=>{setPvisible(!pvisible)}} />}
                        />
                    </View>
                    <View style={[inputStyles.inputContainer]}>
                        <TextInput
                            ...
                            left={<TextInput.Icon icon="lock" color={colors.primary}/>}
                            right={<TextInput.Icon icon={pCvisible?"eye":"eye-off"} color={colors.primary} onPress={()=>{setPCvisible(!pCvisible)}} />}
                        />
                    </View>
                    <View style={[inputStyles.inputContainer]}>
                        <LoginButton
